...
Project Overview:
In Server B, the web application/webpage is deployed using an Apache Web Server.
If we want to make changes to the webpage, instead of manually making changes on the server, we can use Jenkins.
